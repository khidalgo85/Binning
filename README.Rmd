...
A continuação, nos gráficos de barras pode ser observada a abundância relativa dos  MAGs em cada amostra, junto com a afiliação taxonômica no nível de Filum (A) e de Familia (B). Para construir esses gráficos foi usado este [script](https://github.com/khidalgo85/Binning/blob/master/docs/graphs2.R)
...
[Aqui](https://github.com/khidalgo85/Binning/blob/master/imgs/visualization.png) pode abrir o heatmap de cima para fazer zoom.
