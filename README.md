...
**Predição de ORFs - Prodigal**
    ...
    do
    BASE=$(basename $i .fa)
     prodigal -i $i -o 21.ORFsPredicted/${BASE}_orf -a 21.ORFsPredicted/${BASE}_proteins.faa -d 21.ORFsPredicted/${BASE}_ORFnucleotides.faa -s 21.ORFsPredicted/${BASE}_genes
    done 
